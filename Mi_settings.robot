...
Wi-Fi network
    ...
    page should contain text  By changing the Wi-Fi SSID you will be disconnected from the box.
...
Wi-Fi password
    ...
    page should contain text  By changing the Wi-Fi password you will be disconnected from the box.
    page should contain text  CANCEL
    page should contain text  SAVE
    ${btn_cancel}     get element attribute     ${btn_canclelocator}    enabled
    should be equal      ${btn_cancel}        true
...
Guest Wi-Fi security
    ...
    page should contain text    The current scurity level of your Wi-Fi is WPA/WPA2
    page should contain text  WPA2
    page should contain text    Improve the security level of your Wi-Fi connection
...
Access Point Name (APN)
    ...
    click element  ${btn_AccessPointNamelocator}
    ${LinearLayout}     get element attribute     ${LinearLayoutlocator}    enabled
    should be equal     ${LinearLayout}       true
...
Box Language
    ...
    sleep   1s
    page should contain text    The language of the box has been updated successfully.
    sleep  3s
